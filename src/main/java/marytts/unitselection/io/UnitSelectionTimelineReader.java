...
/**
 * Created by moitree on 12/12/16.
 */
public class UnitSelectionTimelineReader {
     ...
     */
    public UnitSelectionTimelineReader(String fileName) throws MaryConfigurationException {
        this(fileName, true);
    }
     ...
     *             if no timeline reader can be instantiated from fileName
     */
    public UnitSelectionTimelineReader(String fileName, boolean tryMemoryMapping) throws MaryConfigurationException {
        if (fileName == null) {
     ...
     */
    protected UnitSelectionTimelineReader() {
    }
    ...
    protected Pair<ByteBuffer, Long> getMappedByteBufferAtTime(long targetTimeInSamples) throws IllegalArgumentException,
        ...
        TimelineReader.IdxField idxFieldBefore = idx.getIdxFieldBefore(targetTimeInSamples);
    ...
    public static class Index {
         ...
         */
        public Index(int idxInterval, Vector<TimelineReader.IdxField> indexFields) throws IllegalArgumentException, NullPointerException {
            if (idxInterval <= 0) {
            ...
            for (int i = 0; i < bytePtrs.length; i++) {
                TimelineReader.IdxField f = indexFields.get(i);
        ...
        public TimelineReader.IdxField getIdxField(int i) {
            ...
            return new TimelineReader.IdxField(bytePtrs[i], timePtrs[i]);
        }
        ...
        public TimelineReader.IdxField getIdxFieldBefore(long timePosition) {
            ...
            return new TimelineReader.IdxField(bytePtrs[index], timePtrs[index]);
        }
    }
